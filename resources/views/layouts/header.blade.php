                                ...
                                <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                                    ...
                                    <div
                                        ...
                                        <ul class="nav flex-nowrap text-nowrap">
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="nav-link {{ Route::is('users.*', 'roles.*', 'features.*', 'pricing.*') ? 'active' : '' }}"
                                                    data-bs-toggle="tab"
                        ...
                        <div class="d-lg-flex container-xxl w-100">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <!--end::Tab panel-->
                                    <!--begin::Tab panel-->
                                    <div class="tab-pane fade {{ Route::is('users.*', 'roles.*', 'features.*', 'pricing.*') ? 'active show' : '' }} " id="kt_header_navs_tab_2">
                                        <!--begin::Wrapper-->
                                        <div
                                            ...
                                            <div class="d-flex flex-column flex-lg-row gap-2">
                                                ...
                                                <a
                                                    class="btn btn-sm btn-light-warning fw-bold {{ Route::is('features.*') ? 'active' : '' }}"
                                                    href="{{ route('features.index') }}">Features</a>
                                                <a
                                                    class="btn btn-sm btn-light-info fw-bold {{ Route::is('pricing.*') ? 'active' : '' }}"
                                                    href="{{ route('pricing.index') }}">Pricing List</a>
                                            </div>
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
