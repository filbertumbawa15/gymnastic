                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <a
                                            ...
                                            class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                    ...
                                    <div
                                        ...
                                        <a
                                            href="../../demo20/dist/apps/projects/project.html"
                                            class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                        ...
                                        <div
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img
                                                    src="{{ asset('src/media/avatars/300-20.jpg') }}"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div
                                            ...
                                            data-bs-placement="top"
                                            title="Alan Nilson">
                                            <img src="{{ asset('src/media/avatars/300-1.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <a
                                        href="#"
                                        class="fs-5 fw-semibold text-gray-800 text-hover-primary mb-2">3 New Incoming Project Files:</a>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        <!--begin::Info-->
                                        ...
                                        <div
                                            ...
                                            data-bs-placement="top"
                                            title="Jan Hummer">
                                            <img src="{{ asset('src/media/avatars/300-23.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img
                                                alt=""
                                                class="w-30px me-3"
                                                src="{{ asset('src/media/svg/files/pdf.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img
                                                alt="../../demo20/dist/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="{{ asset('src/media/svg/files/doc.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            ...
                                            <img
                                                alt="../../demo20/dist/apps/projects/project.html"
                                                class="w-30px me-3"
                                                src="{{ asset('src/media/svg/files/css.svg') }}" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div
                                            ...
                                            data-bs-placement="top"
                                            title="Nina Nilson">
                                            <img src="{{ asset('src/media/avatars/300-14.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div
                                            ...
                                            data-bs-placement="top"
                                            title="Robert Rich">
                                            <img src="{{ asset('src/media/avatars/300-4.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ asset('src/media/avatars/300-25.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                                ...
                                <div class="tab-content rounded h-100 bg-light p-10">
                                    ...
                                    <div
                                        ...
                                        <div class="pt-1">
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                <span
                                                    class="fw-semibold fs-5 text-gray-700 flex-grow-1">Up to 10 Active Users</span>
                                                <i
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                <span
                                                    class="fw-semibold fs-5 text-gray-700 flex-grow-1">Up to 30 Project Integrations</span>
                                                <i
                                                    class="ki-duotone ki-check-circle fs-1 text-success">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                    ...
                                    <div class="tab-pane fade" id="kt_upgrade_plan_enterprise">
                                        ...
                                        <div class="pt-1">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="fw-semibold fs-5 text-gray-700 flex-grow-1">Unlimited Cloud Space</span>
                                                <i
                                                    class="ki-duotone ki-check-circle fs-1 text-success">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                    ...
                                    <div class="tab-pane fade" id="kt_upgrade_plan_custom">
                                        ...
                                        <div class="pt-1">
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                <span
                                                    class="fw-semibold fs-5 text-gray-700 flex-grow-1">Unlimited Project Integrations</span>
                                                <i
                                                    class="ki-duotone ki-check-circle fs-1 text-success">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-6">
                                                        <a
                                                            href="#"
                                                            class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Product Specifications</a>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-6">
                                                        <a
                                                            href="#"
                                                            class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Campaign Creative Poster</a>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-6">
                                                        <a
                                                            href="#"
                                                            class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Campaign Landing Page Source</a>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-6">
                                                        <a
                                                            href="#"
                                                            class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Landing Page Styling</a>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-6">
                                                        <a
                                                            href="#"
                                                            class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Design Source Files</a>
                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-6">
                                                        <a
                                                            href="#"
                                                            class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Campaign Plan Document</a>
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="text-center px-4">
                                        <img
                                            src="{{ asset('src/media/illustrations/sketchy-1/9.png') }}"
                                            alt=""
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div
                                                    ...
                                                    <img
                                                        src="{{ asset('src/media/svg/card-logos/visa.svg') }}"
                                                        alt=""
                                                        class="h-25px" />
                                                    <img
                                                        src="{{ asset('src/media/svg/card-logos/mastercard.svg') }}"
                                                        alt=""
                                                        class="h-25px" />
                                                    <img
                                                        src="{{ asset('src/media/svg/card-logos/american-express.svg') }}"
                                                        alt=""
                                                        class="h-25px" />
                                                </div>
                                                <!--end::Card logos-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img
                            alt="Logo"
                            src="{{ asset('src/media/svg/brand-logos/google-icon.svg') }}"
