                            ...
                            <ul class="nav">
                                <li class="nav-item">
                                    <a
                                        ...
                                        data-bs-toggle="tab"
                                        href="#kt_table_widget_6_tab_1">Harian</a>
                                </li>
                                <li class="nav-item">
                                    <a
                            ...
                            <div class="tab-pane fade show active" id="kt_table_widget_6_tab_1">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle gs-0 gy-3">
                                        ...
                                        <!--begin::Table body-->
                                        <tbody>
                                            @foreach ($memberdays as $member)
                                            <tr>
                                                <td>
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('src/media/svg/avatars/001-boy.svg') }}"
                                                ...
                                                <td>
                                                    <span class="text-muted fw-semibold d-block fs-7">Start Date</span>
                                                    <span class="text-dark fw-bold d-block fs-5">
                                                        {{ \Carbon\Carbon::parse($member->start_date)->format('d M Y') }}
                                                    </span>
                                                </td>
                                                <td class="text-end">
                                                    <span class="text-muted fw-semibold d-block fs-7">End Date</span>
                                                    <span class="text-dark fw-bold d-block fs-5">
                            ...
                            <div class="tab-pane fade" id="kt_table_widget_6_tab_2">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle gs-0 gy-3">
                                        ...
                                        <!--begin::Table body-->
                                        <tbody>
                                            @foreach ($membermonths as $member)
                                            <tr>
                                                <td>
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('src/media/svg/avatars/043-boy-18.svg') }}"
                                                                class="h-75 align-self-end"
                                                                alt="" />
                                                        </span>
                                                    </div>
                            ...
                            <div
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle gs-0 gy-3">
                                        ...
                                        <!--begin::Table body-->
                                        <tbody>
                                            @foreach ($memberyears as $member)
                                            <tr>
                                                <td>
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('src/media/svg/avatars/014-girl-7.svg') }}"
                                                                class="h-75 align-self-end"
                                                                alt="" />
                                                        </span>
                                                    </div>
