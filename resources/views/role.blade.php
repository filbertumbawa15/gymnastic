...
<!-- Modal -->
<div class="modal fade" id="crudModal" tabindex="-1" aria-labelledby="rolesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="crudModalTitle">Roles Form</h5>
            ...
            <div class="modal-body">
                ...
                <form class="form w-100" id="crudForm" data-action="add">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="text" class="form-control bg-transparent" id="rolename" name="rolename" autocomplete="off">
                    </div>
            </div>
