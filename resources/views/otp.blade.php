...
<body id="kt_body" class="auth-bg">
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form class="form w-100 mb-13" novalidate="novalidate" data-kt-redirect-url="../../demo20/dist/index.html" id="kt_sing_in_two_factor_form">
                            @csrf
                            <!--begin::Icon-->
                            <div class="text-center mb-10">
                                <img alt="Logo" class="mh-125px" src="{{ asset('src/media/svg/misc/smartphone-2.svg') }}" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Heading-->
                            <div class="text-center mb-10">
    ...
    <script src="{{ asset('src/js/custom/authentication/sign-in/two-factor.js') }}"></script>
